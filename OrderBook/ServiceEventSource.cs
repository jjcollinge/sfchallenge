...
namespace OrderBook
{
    [EventSource(Name = "MyCompany-Exchange-OrderBook")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        [Event(MaxPendingLimitReached, Level = EventLevel.Critical, Message = "Max number of pending orders in the OrderBook hit, please optimize further.")]
