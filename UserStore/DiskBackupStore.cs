...
namespace UserStore
{
    public class DiskBackupStore: IBackupStore
    {
        ...
        public DiskBackupStore(ConfigurationSection configSection, string partitionId, long keymin, long keymax, string codePackageTempDirectory)
        {
            this.keyMin = keymin;
            this.keyMax = keymax;
